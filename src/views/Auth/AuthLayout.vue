<template>
  <div>
    ...
    <div class="wrapper wrapper-full-page">
      <div class="full-page section-image" :class="pageClass" filter-color="black" data-image="img/bg1.jpg">
        <div class="content">
          <div class="container">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <nav>
              <ul>
                <li>
                  <a href="https://www.azstrut.org">AZStrut</a>
                </li>
              </ul>
            </nav>
            <div class="copyright">
              Coded by
              <a href="https://github.com/mogbanna" target="_blank">Mogbanna</a>
            </div>
          </div>
        </footer>

        <div class="full-page-background" style="backgroundImage: url('img/bg1.jpg')"></div>
      </div>
    </div>
  </div>
</template>
